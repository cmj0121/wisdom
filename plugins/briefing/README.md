...
> before answering it, and drives discussion one numbered topic at a time. Use when running
> agent-smith or tenth-man, or when the user asks for shorter output or to decide one thing at a
> time.
